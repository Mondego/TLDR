...
repo_dir=("$repo_base/projects/NEW/commons-collections" "$repo_base/projects/NEW/commons-cli" "$repo_base/projects/NEW/commons-fileupload" "$repo_base/projects/NEW/OpenTripPlanner") 
...
do
	...
	while read -r line; do
	    ...
	    if [ $count != 0 ]; then
				...
				#Ekstazi experiment
				echo "TIME : " >> $e_log
		    	{ time report_ekstazi=$(mvn -q org.ekstazi:ekstazi-maven-plugin:5.3.0:ekstazi -Drat.skip=true -Dcheckstyle.skip=true -Denforcer.skip=true) ; } 2> $e_log
		    	echo '=========================================================' >> $e_log
		    	echo '=========================================================' >> $e_log		    	
		    	...
		    	# STARTS experiment		    	
		    	echo "TIME : " >> $s_log
		    	{ time report_starts=$(mvn -q edu.illinois:starts-maven-plugin:1.4-SNAPSHOT:starts -Drat.skip=true -Dcheckstyle.skip=true -Denforcer.skip=true) ; } 2> $s_log
		    	echo '=========================================================' >> $s_log
		    	echo '=========================================================' >> $s_log		    	
